...
* $e^{\beta_i}$ is the multiplier of the odds associated with a one unit increase in $x_i$ (for example, an extra point rating in physical attractiveness), assuming all else equal - because of the multiplicative effect, we call this the *odds ratio*
...
Previously we looked at the fit of a linear regression model and determined a metric called $R^2$, which determined how much of the variance of $y$ was explained by our model.  This is not so straightforward in binomial logistic regression, and in fact still the subject of intense research.  
...
## Next time:
Multinomial Logistic Regression for outcomes that are discreet categories. 
